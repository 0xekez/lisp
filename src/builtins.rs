...
/// the argument.
pub fn quote(args: &RevSlice<LustData>, _env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
    check_arg_len("quote", 1, args)?;
    Ok(CallResult::Ret(args[0].clone()))
}

/// Returns the first item in a list or () if the list is empty.
pub fn car(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
/// item in the list.
pub fn cdr(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn cons(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
/// result of ELSE.
pub fn if_(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn eval(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn error(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn import(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn negate(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn add(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn sub(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn mul(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
pub fn div(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
/// less than RIGHT.
pub fn lt(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
/// Takes two numeric arguments LEFT and RIGHT and returns if LEFT is
/// greater than RIGHT.
pub fn gt(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
...
/// Takes two numeric arguments LEFT and RIGHT and returns if LEFT is
/// equal to RIGHT.
pub fn eq(args: &RevSlice<LustData>, env: Rc<RefCell<LustEnv>>) -> Result<CallResult, String> {
    check_arg_len("gt", 2, args)?;
    let l = Interpreter::eval_in_env(&args[0], env.clone())?;
    let r = Interpreter::eval_in_env(&args[1], env.clone())?;
    Ok(CallResult::Ret(get_truthy_equiv(l == r)))
...
fn is_comma(data: &LustVec<LustData>) -> bool {
    match data.first() {
        Some(ref d) => {
...
/// number of arguments.
fn check_arg_len(name: &str, expected: usize, args: &RevSlice<LustData>) -> Result<(), String> {
